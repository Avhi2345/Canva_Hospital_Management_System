...
function Copyright(props) {
    return (
        <Typography variant="body2" color="text.secondary" align="center" {...props}>
            {'Developed with 🖤 by '}
            <strong><a className='text-style' href="#" target="_blank" rel="noreferrer noopener">Abhijeet Kashyap</a> </strong>{'Copyright ©'}
                    ...
                    <Grid container
                        ...
                        <Grid sx={{ m: 'auto' }} item xs={12} sm={6} md={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="mailto:abhijeetkashyap5344@gmail.com">
                                abhijeetkashyap5344@gmail.com
                                </a>
                            </Stack >
                        ...
                        <Grid item xs={12} sm={4}>
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://www.linkedin.com/pulse/hospital-management-system-abhishek-ranjan-4dwoc/?trackingId=vK8YWge0RDu%2Bfp1Bdz2DHQ%3D%3D " target="_blank" rel="noopener noreferrer" >
                                    LinkedIn
                                </a>
                            </Stack >
                            ...
                            <Stack direction="row"
                                ...
                                <a className='text-style' href="https://github.com/Avhi23456" target="_blank" rel="noopener noreferrer" >
                                    GitHub
                                </a>
                            </Stack >
